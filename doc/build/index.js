 ...
 * @module kcopy
 **/
KISSY.add('kg/kcopy/2.0.0/index',function (S, Node,Base) {
    var EMPTY = '';
    var $ = Node.all;
    ...
    var _getZoomFactor = function() {
        ...
        if (typeof document.body.getBoundingClientRect === "function") {
            ...
            zoomFactor = Math.round(physicalWidth / logicalWidth * 2.0.0) / 2.0.0;
        }
        return zoomFactor;
    };
